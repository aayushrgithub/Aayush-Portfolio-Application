  ...
  return (
    <div className='w-full'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <img className='w-full absolute z-1 h-48 md:h-72 object-cover' src='https://i.stack.imgur.com/gNTbn.jpg' />
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        ...
        <a href='https://github.com/aayushrgithub/Aayush_Amazon'>  <button className='rounded-lg bg-gradient-to-r from-red-400 to-blue-400 text-gray-100 font-bold px-8 py-2 mt-4'>Code</button></a>
        </div>
